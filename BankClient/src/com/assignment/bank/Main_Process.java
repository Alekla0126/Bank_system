...
public class Main_Process
{
    ...
    static void pros_acc_num()
    {
        ...
        try
        {
            ...
            if (Main_Driver.bank_pros.checkAccNum(Main_Driver.acc_num))
            {
                ...
                {
                    Numpad_Panel.in_disp = "<html><p style=\"text-align:center;\"> ESTA CUENTA ESTA BLOQUEADA <br><br> POFAVOR CHECA EN LA SUCURSAL MÁS CERCANA ";
            ...
            {
                Numpad_Panel.in_disp = "<html><p style=\"text-align:center;\"> LA CUENTA NO EXISTE <br><br> INTENTA DE NUEVO <br><br>";
    ...
    static void pros_acc_pin()
    {
        try
        {
            ...
            if (Main_Driver.tries > last_atm)
            {
                ...
                {
                    Main_Driver.tries--;
                    Numpad_Panel.in_disp = "<html><p style=\"text-align:center;\"><html> INCORRECT PIN <br><br> INTRODUCE EL PIN <br><br>INTENTOS RESTANTES : " + Main_Driver.tries + "<br><br>";
                    Main_Driver.new_num.display_message();
                    Numpad_Panel.in.clear();
                    Main_Driver.new_num.input();
                }
            ...
            else
            {
                ...
                Numpad_Panel.in_disp = "<html><p style=\"text-align:center;\"><html> DEMASIADOS INTENTOS FALLIDOS <br><br> LA CUENTA SE HA BLOQUEADO <br><br> REVISA EN LA SUCURSAL MÁS CERCANA ";
                Main_Driver.new_num.display_message();
                Main_Driver.new_num.lock_panel();
            }
        }
    ...
    static void pros_depo()
    {
        ...
        try
        {
            ...
            Menu_Panel.menu_disp = "<html><p style=\"text-align:center;\"> DEPOSITO EXITOSO <br><br> ";
            new Menu_Panel().setVisible(true);
    ...
    static void pros_with()
    {
        ...
        try
        {
            ...
            if (Main_Driver.bank_pros.checkOverdraft(Main_Driver.acc_num, with_val))
            {
                ...
                Numpad_Panel.in_disp = "<html><p style=\"text-align:center;\"> LA CANTIDAD SUPERA EL SALDO DISPONIBLE <br><br> INGRESE NUEVA CANTIDAD <br><br>MXN <html>";
                Main_Driver.new_num.display_message();
            }
            else
            {
                Main_Driver.bank_pros.withdraw(Main_Driver.acc_num, with_val);
                Menu_Panel.menu_disp = "<html><p style=\"text-align:center;\"> TRANSACCIÓN EXITOSA <br><br> ";
                new Menu_Panel().setVisible(true);
            }
        }
        catch (RemoteException ex)
