...
public class Menu_Panel extends javax.swing.JFrame
{
    ...
    void get_bal()
    {
        try
        {
            ...
            acc_bal = "<html><p style=\"text-align:center;\"> BALANCE DISPONIBLE <br><br>MXN " + Main_Driver.bank_pros.checkBalance(Main_Driver.acc_num);
    ...
    private void initComponents()
    {
        ...
        cancel_btn.setBackground(new java.awt.Color(0, 153, 204));
        cancel_btn.setFont(new java.awt.Font("MesloLGS NF", 0, 18)); // NOI18N
        ...
        trans_btn.setBackground(new java.awt.Color(0, 153, 204));
        trans_btn.setFont(new java.awt.Font("MesloLGS NF", 0, 18)); // NOI18N
        trans_btn.setForeground(new java.awt.Color(255, 255, 255));
        trans_btn.setText("Historial de transacciones");
        ...
        with_btn.setBackground(new java.awt.Color(0, 153, 204));
        with_btn.setFont(new java.awt.Font("MesloLGS NF", 0, 18)); // NOI18N
        with_btn.setForeground(new java.awt.Color(255, 255, 255));
        with_btn.setText("Retira fondos");
        with_btn.setBorderPainted(false);
        with_btn.setContentAreaFilled(false);
        with_btn.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        with_btn.setOpaque(true);
        ...
        depo_btn.setBackground(new java.awt.Color(0, 153, 204));
        depo_btn.setFont(new java.awt.Font("MesloLGS NF", 0, 18)); // NOI18N
        depo_btn.setForeground(new java.awt.Color(255, 255, 255));
        depo_btn.setText("Deposita fondos");
        depo_btn.setBorderPainted(false);
        depo_btn.setContentAreaFilled(false);
        depo_btn.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        depo_btn.setOpaque(true);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(depo_btn, javax.swing.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
                    .addComponent(info_panel, javax.swing.GroupLayout.PREFERRED_SIZE, 376, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(with_btn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(32, 32, 32)
                .addComponent(info_panel, javax.swing.GroupLayout.PREFERRED_SIZE, 288, javax.swing.GroupLayout.PREFERRED_SIZE)
