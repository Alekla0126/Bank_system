...
public class Main_Driver
{
    ...
    static void fun_acc_num()
    {
        ...
        Numpad_Panel.in_disp = "<html><p style=\"text-align:center;\"><html> ENTRE EL NUMERO DE CUENTA <br><br>";
    ...
    static void fun_acc_pin()
    {
        ...
        Numpad_Panel.in_disp = "<html><p style=\"text-align:center;\"><html> ENTRA EL PIN <br><br>INTENTOS RESTANTES : " + tries + "<br><br>";
        new_num = new Numpad_Panel();
        Numpad_Panel.in.clear();
        new_num.setVisible(true);
        new_num.input();
    ...
    static void fun_depo()
    {
        opt = "depo";
        Numpad_Panel.in_size = IN_MED;
        Numpad_Panel.in_disp = "<html><p style=\"text-align:center;\"> INTRODUZE EL MONTO A DEPOSITAR <br><br>MXN ";
        new_num = new Numpad_Panel();
        Numpad_Panel.in.clear();
        new_num.setVisible(true);
        new_num.input();
    ...
    static void fun_with()
    {
        opt = "with";
        Numpad_Panel.in_size = IN_MED;
        Numpad_Panel.in_disp = "<html><p style=\"text-align:center;\"> INTRODUZE EL MONTO A RETIRAR <br><br>MXN ";
        new_num = new Numpad_Panel();
        Numpad_Panel.in.clear();
        new_num.setVisible(true);
        new_num.input();
    ...
    {
        opt = "pay_acc";
        Option_Panel.opt_disp = "<html><p style=\"text-align:center;\"> SELECCIONA SERVICIO A PAGAR ";
    ...
    static void fun_pay_num()
    {
        ...
        Numpad_Panel.in_disp = "<html><p style=\"text-align:center;\"> iNTRODUCE " + pay + "NUMERO DE CUENTA <br><br>";
        Numpad_Panel.in.clear();
        new_num = new Numpad_Panel();
        Numpad_Panel.in.clear();
        new_num.setVisible(true);
    ...
    static void fun_pay_amt()
    {
        opt = "pay";
        Numpad_Panel.in_size = IN_MED;
        Numpad_Panel.in_disp = "<html><p style=\"text-align:center;\"> INTRODUCE MONTO A PAGAR <br><br> MSN ";
        new_num = new Numpad_Panel();
        Numpad_Panel.in.clear();
        new_num.setVisible(true);
        new_num.input();
